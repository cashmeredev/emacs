...
ERC configuration for connecting to IRC via Soju bouncer. Connects to
both Libera.Chat and Ergo networks. Perspective integration isolates
IRC buffers in their own workspace. Consult source for ERC-only buffer
switching. Evil normal-mode keybindings for channel navigation.
