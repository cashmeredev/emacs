...
*** effort and complexity enhancements

Better effort estimates for deep work sessions and automatic complexity mapping.
...
Interactive project creation with denote - includes structure, deadlines, timers, and clocktables.
...
*** daily review - your way

Flexible end-of-day closure ritual. Use whenever you feel like wrapping up the day.
...
For when YOU feel like doing a bigger review - no schedule, no pressure.
...
Schedule everything - work, meals, personal time - with interactive time blocks.
