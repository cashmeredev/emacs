...
(my-leader
  ...
  "pp" '(fzfa-project-switch-project :wk "switch project")
...
(defun my/fzfa-switch-project-find-file ()
  "Switch to a known project and immediately browse its files.
Like `consult-projectile': pick a project, then a file — without the
`project-switch-project' dispatch menu.  Binding
`project-switch-commands' to a symbol makes `project-switch-project'
invoke it directly."
  (interactive)
  (let ((project-switch-commands 'fzfa-project-find-file))
