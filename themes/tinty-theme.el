;;; tinty-theme.el --- tinty theme for Emacs -*- lexical-binding: t -*-


;; Copyright (C) 2025

;; Author: tinty User Template (Fixed)
;; Version: 2.0
...
;; tinty Emacs theme generated via user template.
...
(deftheme tinty
  "tinty theme with proper color contrast."
...
(let* (;; Tinted8 UI surface colors
       ...
       (ui-selection-bg "#cfcfde")
       (ui-selection-fg "#1f1f1f")
       (ui-button-bg "#d5d5d5")
       (ui-button-fg "#1f1f1f")
       (ui-tooltip-bg "#e5e5e5")
       (ui-tooltip-fg "#1f1f1f")
       (ui-active-text-bg "#cfcfde")
       (ui-active-text-fg "#2f2f2f")
       (ui-search-bg "#e5e5e5")
       (ui-search-fg "#2f2f2f")

       ;; Tinted8 syntax colors
       ;; The builder already corrects syntax colors for text contrast, including light variants.
       (syntax-comment "#635d97")
       (syntax-documentation "#635d97")
       (syntax-constant "#a34d14")
       (syntax-function "#14710a")
       (syntax-keyword "#a3144d")
       (syntax-string "#846e15")
       (syntax-type "#036a96")
       ;; Give variables/imported names a distinct hue instead of blending into
       ;; the default foreground.
       (syntax-variable "#1f1f1f")
       (syntax-warning "#cb3a2a")
       (syntax-preprocessor "#336699")
       (syntax-annotation "#846e15")
       (syntax-attribute "#036a96")
       (syntax-number "#a34d14")
       (syntax-operator "#036a96")
  ...
  (custom-theme-set-faces
   ...
   ;; === Company ===
   `(company-tooltip ((t (:background ,ui-tooltip-bg :foreground ,ui-tooltip-fg))))
   `(company-tooltip-selection ((t (:background ,ui-selection-bg :foreground ,ui-selection-fg :weight bold))))
   ...
   `(company-tooltip-common-selection ((t (:foreground ,ui-selection-fg :weight bold))))
   `(company-tooltip-annotation ((t (:foreground ,ui-fg-dim))))
   `(company-tooltip-annotation-selection ((t (:foreground ,ui-selection-fg))))
   ...
   `(term-color-red ((t (:foreground "#cb3a2a" :background "#cb3a2a"))))
   `(term-color-green ((t (:foreground "#14710a" :background "#14710a"))))
   `(term-color-yellow ((t (:foreground "#846e15" :background "#846e15"))))
   `(term-color-blue ((t (:foreground "#644ac9" :background "#644ac9"))))
   `(term-color-magenta ((t (:foreground "#a3144d" :background "#a3144d"))))
   `(term-color-cyan ((t (:foreground "#036a96" :background "#036a96"))))
   `(term-color-white ((t (:foreground "#6e6e6e" :background "#6e6e6e"))))
   ...
   `(ansi-color-bright-black ((t (:foreground "#4f4f4f" :background "#4f4f4f"))))
   `(ansi-color-bright-red ((t (:foreground "#cb3a2a" :background "#cb3a2a"))))
   `(ansi-color-bright-green ((t (:foreground "#14710a" :background "#14710a"))))
   `(ansi-color-bright-yellow ((t (:foreground "#846e15" :background "#846e15"))))
   `(ansi-color-bright-blue ((t (:foreground "#644ac9" :background "#644ac9"))))
   `(ansi-color-bright-magenta ((t (:foreground "#a3144d" :background "#a3144d"))))
   `(ansi-color-bright-cyan ((t (:foreground "#036a96" :background "#036a96"))))
   `(ansi-color-bright-white ((t (:foreground "#707070" :background "#707070"))))
   ...
   `(term-color-bright-black ((t (:foreground "#4f4f4f" :background "#4f4f4f"))))
   `(term-color-bright-red ((t (:foreground "#cb3a2a" :background "#cb3a2a"))))
   `(term-color-bright-green ((t (:foreground "#14710a" :background "#14710a"))))
   `(term-color-bright-yellow ((t (:foreground "#846e15" :background "#846e15"))))
   `(term-color-bright-blue ((t (:foreground "#644ac9" :background "#644ac9"))))
   `(term-color-bright-magenta ((t (:foreground "#a3144d" :background "#a3144d"))))
   `(term-color-bright-cyan ((t (:foreground "#036a96" :background "#036a96"))))
   `(term-color-bright-white ((t (:foreground "#707070" :background "#707070"))))
