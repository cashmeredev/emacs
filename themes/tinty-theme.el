...
(let* (;; Tinted8 UI surface colors
       ...
       (syntax-variable "#670be0")
       (syntax-warning "#f02e58")
       (syntax-preprocessor "#0248d4")
       (syntax-annotation "#df8e1d")
       (syntax-attribute "#598ef8")
  ...
  (custom-theme-set-faces
   ...
   `(term-color-red ((t (:foreground "#d20f39" :background "#d20f39"))))
   `(term-color-green ((t (:foreground "#40a02b" :background "#40a02b"))))
   `(term-color-yellow ((t (:foreground "#df8e1d" :background "#df8e1d"))))
