...
(let* (;; Tinted8 UI surface colors
       ...
       (ui-selection-bg "#444155")
       (ui-selection-fg "#b2b2b2")
       (ui-button-bg "#42444a")
       (ui-button-fg "#e3dedd")
       (ui-tooltip-bg "#34323e")
       (ui-tooltip-fg "#9a9aba")
       (ui-active-text-bg "#5d4d7a")
       (ui-active-text-fg "#e3dedd")
       (ui-search-bg "#86dc2f")
       (ui-search-fg "#292b2e")
       ...
       (syntax-constant "#a45bad")
       (syntax-function "#bc6ec5")
       (syntax-keyword "#4f97d7")
       (syntax-string "#2d9574")
       (syntax-type "#ce537a")
       ;; Give variables/imported names a distinct hue instead of blending into
       ;; the default foreground.
       (syntax-variable "#7590db")
       (syntax-warning "#f2241f")
       (syntax-preprocessor "#c56ec3")
       (syntax-annotation "#b1951d")
       (syntax-attribute "#7590db")
       (syntax-number "#a45bad")
       (syntax-operator "#4f97d7")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-doc-face ((t (:foreground ,syntax-comment :slant italic))))
   ...
   ;; === Mode line ===
   `(mode-line ((t (:background ,ui-line-highlight :foreground ,ui-fg :box (:line-width -1 :color ,ui-border)))))
   `(mode-line-inactive ((t (:background ,ui-bg-dark :foreground ,ui-fg-dim :box (:line-width -1 :color ,ui-border)))))
   ...
   `(org-level-1 ((t (:foreground ,pal-red :weight bold :height 1.2))))
   `(org-level-2 ((t (:foreground ,pal-orange :weight bold :height 1.1))))
   `(org-level-3 ((t (:foreground ,pal-yellow :weight bold))))
   `(org-level-4 ((t (:foreground ,pal-green :weight bold))))
   `(org-level-5 ((t (:foreground ,pal-cyan :weight bold))))
   `(org-level-6 ((t (:foreground ,pal-blue :weight bold))))
   `(org-level-7 ((t (:foreground ,pal-magenta :weight bold))))
   `(org-level-8 ((t (:foreground ,pal-gray :weight bold))))
   `(org-document-title ((t (:foreground ,pal-red :weight bold :height 1.3))))
   `(org-document-info ((t (:foreground ,ui-fg-dim))))
   `(org-todo ((t (:foreground ,pal-orange :weight bold))))
   `(org-done ((t (:foreground ,pal-green :weight bold))))
   `(org-headline-done ((t (:foreground ,ui-fg-dim))))
   `(org-hide ((t (:foreground ,ui-bg))))
   `(org-ellipsis ((t (:foreground ,pal-cyan :underline nil))))
   `(org-table ((t (:foreground ,ui-link :inherit fixed-pitch))))
   `(org-formula ((t (:foreground ,pal-orange :inherit fixed-pitch))))
   `(org-checkbox ((t (:foreground ,pal-blue :weight bold :inherit fixed-pitch))))
   `(org-date ((t (:foreground ,pal-cyan :underline t))))
   ...
   `(magit-branch-local ((t (:foreground ,pal-blue :weight bold))))
   `(magit-branch-remote ((t (:foreground ,pal-green :weight bold))))
   ...
   `(company-tooltip-search ((t (:foreground ,ui-error :weight bold))))
   `(company-tooltip-search-selection ((t (:foreground ,ui-error :background ,ui-selection-bg :weight bold))))
   ...
   `(ido-only-match ((t (:foreground ,pal-cyan :weight bold))))
   `(ido-subdir ((t (:foreground ,pal-blue))))
   ...
   `(completions-first-difference ((t (:foreground ,pal-orange))))
   ...
   `(which-key-group-description-face ((t (:foreground ,pal-blue))))
   `(which-key-local-map-description-face ((t (:foreground ,pal-cyan))))
   `(which-key-special-key-face ((t (:foreground ,pal-orange :weight bold))))
   ...
   `(term-color-red ((t (:foreground "#f2241f" :background "#f2241f"))))
   `(term-color-green ((t (:foreground "#67b11d" :background "#67b11d"))))
   `(term-color-yellow ((t (:foreground "#b1951d" :background "#b1951d"))))
   `(term-color-blue ((t (:foreground "#4f97d7" :background "#4f97d7"))))
   `(term-color-magenta ((t (:foreground "#a31db1" :background "#a31db1"))))
   `(term-color-cyan ((t (:foreground "#28def0" :background "#28def0"))))
   `(term-color-white ((t (:foreground "#b2b2b2" :background "#b2b2b2"))))
   ...
   `(markdown-header-face ((t (:foreground ,pal-red :weight bold))))
   `(markdown-header-face-1 ((t (:foreground ,pal-red :weight bold :height 1.2))))
   `(markdown-header-face-2 ((t (:foreground ,pal-orange :weight bold :height 1.1))))
   `(markdown-header-face-3 ((t (:foreground ,pal-yellow :weight bold))))
   `(markdown-header-face-4 ((t (:foreground ,pal-green :weight bold))))
   `(markdown-header-face-5 ((t (:foreground ,pal-cyan :weight bold))))
   `(markdown-header-face-6 ((t (:foreground ,pal-blue :weight bold))))
   `(markdown-inline-code-face ((t (:foreground ,pal-cyan :background ,ui-bg-dark :inherit fixed-pitch))))
   ...
   ;; === Web mode ===
   `(web-mode-html-tag-face ((t (:foreground ,ui-accent))))
   `(web-mode-html-tag-bracket-face ((t (:foreground ,ui-fg-dim))))
   `(web-mode-html-attr-name-face ((t (:foreground ,ui-link))))
   `(web-mode-html-attr-value-face ((t (:foreground ,ui-info))))
   `(web-mode-css-selector-face ((t (:foreground ,ui-accent))))
   `(web-mode-css-property-name-face ((t (:foreground ,ui-link))))
   `(web-mode-css-string-face ((t (:foreground ,ui-info))))

   ;; === Flycheck ===
   `(flycheck-error ((t (:underline (:style wave :color ,ui-error)))))
   `(flycheck-warning ((t (:underline (:style wave :color ,ui-link)))))
   `(flycheck-info ((t (:underline (:style wave :color ,ui-info)))))
   `(flycheck-fringe-error ((t (:foreground ,ui-error))))
   `(flycheck-fringe-warning ((t (:foreground ,ui-link))))
   ...
   `(info-title-1 ((t (:foreground ,pal-red :weight bold :height 1.3))))
   `(info-title-2 ((t (:foreground ,pal-orange :weight bold :height 1.2))))
   `(info-title-3 ((t (:foreground ,pal-yellow :weight bold :height 1.1))))
   `(info-title-4 ((t (:foreground ,pal-green :weight bold))))
   `(Info-quoted ((t (:foreground ,pal-cyan))))
   `(info-menu-header ((t (:foreground ,pal-red :weight bold))))
   `(info-menu-star ((t (:foreground ,pal-red))))
   `(info-node ((t (:foreground ,pal-cyan :weight bold))))
   ...
   `(centaur-tabs-selected-modified ((t (:background ,ui-bg-light :foreground ,ui-info :weight bold))))
   `(centaur-tabs-unselected-modified ((t (:background ,ui-bg :foreground ,ui-info))))
   ...
   `(isearch-group-1 ((t (:background ,pal-blue :foreground ,ui-bg :weight bold))))
   `(isearch-group-2 ((t (:background ,pal-cyan :foreground ,ui-bg :weight bold))))

   ;; === HL-line ===
   `(hl-line ((t (:background ,ui-bg-dark :extend t))))

   ;; === HL-todo ===
   `(hl-todo ((t (:foreground ,ui-error :weight bold))))
   ...
   `(outline-1 ((t (:foreground ,pal-red :weight ultra-bold))))
   `(outline-2 ((t (:foreground ,pal-orange :weight bold))))
   `(outline-3 ((t (:foreground ,pal-yellow :weight bold))))
   `(outline-4 ((t (:foreground ,pal-green))))
   `(outline-5 ((t (:foreground ,pal-cyan))))
   `(outline-6 ((t (:foreground ,pal-blue))))
   `(outline-7 ((t (:foreground ,pal-magenta))))
   `(outline-8 ((t (:foreground ,pal-gray))))
   `(outline-minor-1 ((t (:foreground ,pal-red :weight ultra-bold))))
   `(outline-minor-2 ((t (:foreground ,pal-orange :weight bold))))
   `(outline-minor-3 ((t (:foreground ,pal-yellow :weight bold))))
   `(outline-minor-4 ((t (:foreground ,pal-green))))
   `(outline-minor-5 ((t (:foreground ,pal-cyan))))
   `(outline-minor-6 ((t (:foreground ,pal-blue))))
   `(outline-minor-7 ((t (:foreground ,pal-magenta))))
   `(outline-minor-8 ((t (:foreground ,pal-gray))))

   ;; === Org (missing faces) ===
   `(org-archived ((t (:foreground ,ui-border))))
   `(org-block-background ((t (:background ,ui-bg-dark :extend t))))
   `(org-checkbox-statistics-done ((t (:foreground ,ui-border :weight bold))))
   `(org-checkbox-statistics-todo ((t (:foreground ,ui-info :weight bold))))
   ...
   `(org-warning ((t (:foreground ,ui-link :weight bold))))
   ...
   `(org-agenda-done ((t (:foreground ,ui-info))))
   ...
   `(org-journal-calendar-scheduled-face ((t (:foreground ,ui-error :slant italic))))
   `(org-journal-highlight ((t (:foreground ,ui-info))))

   ;; === Org pomodoro ===
   `(org-pomodoro-mode-line ((t (:foreground ,ui-error))))
   `(org-pomodoro-mode-line-overtime ((t (:foreground ,ui-link :weight bold))))
   ...
   `(org-ref-ref-face ((t (:foreground ,ui-error :underline t :weight bold))))

   ;; === Ace-window ===
   `(aw-leading-char-face ((t (:foreground ,ui-error :height 500 :weight bold))))
   ...
   `(ansi-color-bright-black ((t (:foreground "#42444a" :background "#42444a"))))
   `(ansi-color-bright-red ((t (:foreground "#f55d59" :background "#f55d59"))))
   `(ansi-color-bright-green ((t (:foreground "#86dd2e" :background "#86dd2e"))))
   `(ansi-color-bright-yellow ((t (:foreground "#ddbc2e" :background "#ddbc2e"))))
   `(ansi-color-bright-blue ((t (:foreground "#81b4e2" :background "#81b4e2"))))
   `(ansi-color-bright-magenta ((t (:foreground "#cc2edd" :background "#cc2edd"))))
   `(ansi-color-bright-cyan ((t (:foreground "#61e7f4" :background "#61e7f4"))))
   `(ansi-color-bright-white ((t (:foreground "#e3dedd" :background "#e3dedd"))))
   ...
   `(compilation-line-number ((t (:foreground ,ui-error))))
   `(compilation-mode-line-exit ((t (:foreground ,ui-info))))
   `(compilation-mode-line-fail ((t (:foreground ,ui-error :weight bold))))
   `(compilation-warning ((t (:foreground ,ui-link :slant italic))))

   ;; === Consult ===
   `(consult-file ((t (:foreground ,ui-fg-dim))))
   `(consult-bookmark ((t (:foreground ,pal-yellow))))
   ...
   `(consult-highlight-match ((t (:foreground ,pal-orange :weight bold))))
   ...
   `(custom-saved ((t (:foreground ,ui-info :weight bold))))
   ...
   ;; === Calendar ===
   `(calendar-today ((t (:foreground ,pal-blue :weight bold :underline t))))
   `(calendar-weekend-header ((t (:foreground ,ui-error))))
   `(calendar-weekday-header ((t (:foreground ,pal-cyan))))
   `(calendar-month-header ((t (:foreground ,syntax-keyword :weight bold))))
   `(holiday ((t (:foreground ,pal-orange))))
   `(diary ((t (:foreground ,pal-yellow))))
   ...
   `(epa-field-name ((t (:foreground ,pal-blue :weight bold))))
   `(epa-mark ((t (:foreground ,pal-orange :weight bold))))
   ...
   ;; === Proced ===
   `(proced-mark ((t (:foreground ,pal-orange :weight bold))))
   `(proced-marked ((t (:foreground ,syntax-keyword :weight bold))))
   `(proced-sort-header ((t (:foreground ,pal-blue :weight bold :underline t))))

   ;; === Speedbar ===
   `(speedbar-button-face ((t (:foreground ,ui-success))))
   `(speedbar-directory-face ((t (:foreground ,pal-blue :weight bold))))
   `(speedbar-file-face ((t (:foreground ,ui-fg))))
   `(speedbar-highlight-face ((t (:background ,ui-bg-light))))
   `(speedbar-selected-face ((t (:foreground ,pal-orange :weight bold))))
   `(speedbar-separator-face ((t (:foreground ,ui-border :background ,ui-bg-dark))))
   `(speedbar-tag-face ((t (:foreground ,pal-cyan))))
   ...
   `(vc-locked-state ((t (:foreground ,pal-orange :weight bold))))
   `(vc-missing-state ((t (:foreground ,ui-error))))
   `(vc-needs-update-state ((t (:foreground ,pal-orange))))
   `(vc-removed-state ((t (:foreground ,ui-error))))
   `(vc-up-to-date-state ((t (:foreground ,ui-success))))

   ;; === Xref ===
   `(xref-file-header ((t (:foreground ,pal-blue :weight bold))))
   `(xref-line-number ((t (:foreground ,ui-fg-dim))))
   `(xref-match ((t (:foreground ,pal-orange :weight bold))))

   ;; === Man / Woman ===
   `(Man-overstrike ((t (:foreground ,pal-blue :weight bold))))
   `(Man-underline ((t (:foreground ,pal-cyan :underline t))))
   `(Man-reverse ((t (:foreground ,ui-bg :background ,ui-fg))))
   `(woman-bold ((t (:foreground ,pal-blue :weight bold))))
   ...
   `(diff-changed ((t (:foreground ,ui-link :background ,ui-button-bg :extend t))))
   `(diff-indicator-changed ((t (:foreground ,ui-link :weight bold :background ,ui-button-bg :extend t))))
   `(diff-refine-changed ((t (:foreground ,ui-link :weight bold :background ,ui-button-bg :extend t))))
   ...
   `(diff-file-header ((t (:foreground ,pal-blue :background ,ui-bg-dark :weight bold :extend t))))
   `(diff-hunk-header ((t (:foreground ,pal-orange :background ,ui-bg-dark :extend t))))
   `(diff-function ((t (:foreground ,ui-selection-fg :background ,ui-selection-bg :extend t))))

   ;; === Diff-hl ===
   `(diff-hl-change ((t (:foreground ,ui-link :background ,ui-button-bg))))
   `(diff-hl-delete ((t (:foreground ,ui-error :background ,ui-active-text-bg))))
   `(diff-hl-insert ((t (:foreground ,ui-info :background ,ui-tooltip-bg))))

   ;; === Dired (missing faces) ===
   `(dired-mark ((t (:foreground ,ui-link :weight bold))))
   `(dired-perm-write ((t (:foreground ,ui-error :underline t))))
   `(dired-warning ((t (:foreground ,ui-link))))

   ;; === Diredfl ===
   `(diredfl-file-name ((t (:inherit default))))
   `(diredfl-file-suffix ((t (:inherit default))))
   `(diredfl-autofile-name ((t (:foreground ,ui-border))))
   `(diredfl-compressed-file-name ((t (:foreground ,pal-green))))
   `(diredfl-compressed-file-suffix ((t (:foreground ,pal-green))))
   ...
   `(diredfl-exec-priv ((t (:foreground ,ui-error))))
   `(diredfl-executable-tag ((t (:foreground ,ui-error))))
   ...
   `(diredfl-number ((t (:foreground ,pal-yellow))))
   `(diredfl-other-priv ((t (:inherit diredfl-exec-priv))))
   `(diredfl-rare-priv ((t (:inherit diredfl-exec-priv))))
   `(diredfl-read-priv ((t (:foreground ,pal-cyan))))
   `(diredfl-symlink ((t (:inherit dired-symlink))))
   `(diredfl-tagged-autofile-name ((t (:foreground ,pal-magenta))))
   ...
   ;; === Dired-k ===
   `(dired-k-added ((t (:foreground ,ui-info :weight bold))))
   `(dired-k-commited ((t (:foreground ,ui-info :weight bold))))
   `(dired-k-directory ((t (:foreground ,ui-accent :weight bold))))
   `(dired-k-ignored ((t (:foreground ,ui-border :weight bold))))
   `(dired-k-modified ((t (:foreground ,ui-link :weight bold))))
   `(dired-k-untracked ((t (:foreground ,ui-link :weight bold))))
   ...
   `(doom-modeline-evil-insert-state ((t (:foreground ,ui-error :weight bold))))
   `(doom-modeline-evil-motion-state ((t (:foreground ,ui-accent :weight bold))))
   `(doom-modeline-evil-normal-state ((t (:foreground ,ui-info :weight bold))))
   `(doom-modeline-evil-operator-state ((t (:foreground ,ui-accent :weight bold))))
   `(doom-modeline-evil-replace-state ((t (:foreground ,ui-link :weight bold))))
   ...
   `(elfeed-log-info-level-face ((t (:foreground ,pal-cyan))))
   `(elfeed-log-warn-level-face ((t (:foreground ,ui-warning))))
   `(elfeed-search-date-face ((t (:foreground ,pal-cyan))))
   `(elfeed-search-feed-face ((t (:foreground ,pal-blue))))
   `(elfeed-search-filter-face ((t (:foreground ,syntax-keyword))))
   `(elfeed-search-tag-face ((t (:foreground ,pal-cyan))))
   `(elfeed-search-title-face ((t (:foreground ,ui-fg-dim))))
   `(elfeed-search-unread-count-face ((t (:foreground ,pal-blue :weight bold))))
   ...
   `(cider-repl-prompt-face ((t (:foreground ,pal-blue :weight bold))))
   ...
   ;; === Evil ===
   `(evil-ex-info ((t (:foreground ,ui-error :slant italic))))
   ...
   `(evil-ex-substitute-replacement ((t (:background ,ui-bg-light :foreground ,pal-orange :weight bold))))
   ...
   ;; === Evil-snipe ===
   `(evil-snipe-first-match-face ((t (:foreground ,ui-error :background ,ui-selection-bg :weight bold))))
   `(evil-snipe-matches-face ((t (:foreground ,ui-error :underline t :weight bold))))

   ;; === Flycheck (missing) ===
   `(flycheck-error-list-filename ((t (:foreground ,ui-accent))))
   `(flycheck-error-list-checker-name ((t (:foreground ,ui-accent))))
   `(flycheck-error-list-warning ((t (:foreground ,ui-link))))
   ...
   `(flycheck-posframe-warning-face ((t (:background ,ui-bg-dark :foreground ,ui-link))))

   ;; === Flymake ===
   `(flymake-error ((t (:underline (:style wave :color ,ui-error)))))
   `(flymake-note ((t (:underline (:style wave :color ,ui-info)))))
   `(flymake-warning ((t (:underline (:style wave :color ,ui-link)))))

   ;; === Flyspell ===
   `(flyspell-duplicate ((t (:underline (:style wave :color ,ui-link)))))
   ...
   ;; === Git-gutter ===
   `(git-gutter:added ((t (:foreground ,ui-info))))
   `(git-gutter:deleted ((t (:foreground ,ui-error))))
   `(git-gutter:modified ((t (:foreground ,ui-link))))
   `(git-gutter+-added ((t (:foreground ,ui-info))))
   `(git-gutter+-deleted ((t (:foreground ,ui-error))))
   `(git-gutter+-modified ((t (:foreground ,ui-link))))
   `(git-gutter-fr:added ((t (:foreground ,ui-info))))
   `(git-gutter-fr:deleted ((t (:foreground ,ui-error))))
   `(git-gutter-fr:modified ((t (:foreground ,ui-link))))
   ...
   `(ivy-modified-buffer ((t (:weight bold :foreground ,ui-link))))
   `(ivy-virtual ((t (:slant italic :foreground ,ui-fg))))
   `(ivy-posframe ((t (:background ,ui-bg-dark))))
   `(ivy-posframe-border ((t (:background ,ui-error))))

   ;; === Keycast ===
   `(keycast-command ((t (:foreground ,ui-error))))
   `(keycast-key ((t (:foreground ,ui-error :weight bold))))

   ;; === LSP ===
   `(lsp-face-highlight-textual ((t (:background ,ui-bg-light :weight bold))))
   `(lsp-face-highlight-read ((t (:background ,ui-bg-light))))
   `(lsp-face-highlight-write ((t (:background ,ui-bg-light :weight bold))))
   ...
   `(lsp-ui-doc-url ((t (:foreground ,pal-blue :underline t))))
   `(lsp-ui-peek-filename ((t (:foreground ,pal-orange :weight bold))))
   ...
   `(magit-bisect-good ((t (:foreground ,ui-info))))
   `(magit-bisect-skip ((t (:foreground ,ui-error))))
   `(magit-blame-date ((t (:foreground ,ui-error))))
   `(magit-blame-heading ((t (:foreground ,ui-accent :background ,ui-line-highlight :extend t))))
   `(magit-branch-current ((t (:foreground ,ui-error))))
   `(magit-branch-remote-head ((t (:foreground ,ui-info))))
   `(magit-cherry-equivalent ((t (:foreground ,ui-accent))))
   `(magit-cherry-unmatched ((t (:foreground ,ui-link))))
   `(magit-diff-base ((t (:foreground ,ui-button-fg :background ,ui-button-bg :extend t))))
   `(magit-diff-base-highlight ((t (:foreground ,ui-button-fg :background ,ui-button-bg :weight bold :extend t))))
   ...
   `(magit-diffstat-added ((t (:foreground ,ui-info))))
   ...
   `(magit-process-ok ((t (:foreground ,ui-info))))
   ...
   `(magit-sequence-stop ((t (:foreground ,ui-info))))
   `(magit-signature-bad ((t (:foreground ,ui-error))))
   `(magit-signature-error ((t (:foreground ,ui-error))))
   `(magit-signature-expired ((t (:foreground ,ui-link))))
   `(magit-signature-good ((t (:foreground ,ui-info))))
   `(magit-signature-revoked ((t (:foreground ,ui-link))))
   `(magit-signature-untrusted ((t (:foreground ,ui-link))))
   ...
   `(marginalia-modified ((t (:foreground ,ui-error))))
   ...
   `(markdown-header-face-5 ((t (:foreground ,ui-accent :weight bold))))
   `(markdown-header-face-6 ((t (:foreground ,ui-link :weight bold))))
   ...
   `(message-header-cc ((t (:foreground ,ui-error :weight bold))))
   `(message-header-name ((t (:foreground ,ui-error))))
   ...
   `(neo-root-dir-face ((t (:foreground ,ui-info :background ,ui-bg))))
   `(neo-vc-added-face ((t (:foreground ,ui-info))))
   `(neo-vc-conflict-face ((t (:foreground ,ui-link :weight bold))))
   `(neo-vc-edited-face ((t (:foreground ,ui-link))))
   ...
   `(notmuch-search-flagged-face ((t (:foreground ,ui-error))))
   ...
   `(notmuch-tag-added ((t (:foreground ,ui-info :weight normal))))
   ...
   ;; === Orderless ===
   `(orderless-match-face-0 ((t (:foreground ,pal-blue :weight bold :underline t))))
   `(orderless-match-face-1 ((t (:foreground ,pal-magenta :weight bold :underline t))))
   `(orderless-match-face-2 ((t (:foreground ,pal-cyan :weight bold :underline t))))
   `(orderless-match-face-3 ((t (:foreground ,pal-orange :weight bold :underline t))))
   ...
   `(term-color-bright-black ((t (:foreground "#42444a" :background "#42444a"))))
   `(term-color-bright-red ((t (:foreground "#f55d59" :background "#f55d59"))))
   `(term-color-bright-green ((t (:foreground "#86dd2e" :background "#86dd2e"))))
   `(term-color-bright-yellow ((t (:foreground "#ddbc2e" :background "#ddbc2e"))))
   `(term-color-bright-blue ((t (:foreground "#81b4e2" :background "#81b4e2"))))
   `(term-color-bright-magenta ((t (:foreground "#cc2edd" :background "#cc2edd"))))
   `(term-color-bright-cyan ((t (:foreground "#61e7f4" :background "#61e7f4"))))
   `(term-color-bright-white ((t (:foreground "#e3dedd" :background "#e3dedd"))))

   ;; === Transient ===
   `(transient-heading ((t (:foreground ,pal-blue :weight bold))))
   `(transient-key ((t (:foreground ,pal-magenta :weight bold :height 1.1))))
   `(transient-argument ((t (:foreground ,pal-green))))
   `(transient-value ((t (:foreground ,pal-green))))
   ...
   `(treemacs-root-face ((t (:foreground ,pal-blue :weight bold :height 1.2))))
   `(treemacs-tags-face ((t (:foreground ,ui-error))))
   `(treemacs-help-title-face ((t (:foreground ,syntax-keyword :weight bold))))
   `(treemacs-help-column-face ((t (:foreground ,pal-blue))))
   ...
   `(tree-sitter-hl-face:function.builtin ((t (:foreground ,ui-error))))
   ...
   `(tree-sitter-hl-face:type.builtin ((t (:foreground ,ui-error))))
   ...
   `(tree-sitter-hl-face:variable.builtin ((t (:foreground ,ui-error))))
   ...
   `(tree-sitter-hl-face:constant.builtin ((t (:foreground ,ui-error))))
   ...
   `(tree-sitter-hl-face:punctuation.special ((t (:foreground ,ui-error))))
   `(tree-sitter-hl-face:tag ((t (:foreground ,ui-error))))
   ...
   `(web-mode-builtin-face ((t (:foreground ,ui-error))))
   `(web-mode-symbol-face ((t (:foreground ,syntax-constant))))
   `(web-mode-doctype-face ((t (:foreground ,syntax-comment))))
   `(web-mode-html-tag-face ((t (:foreground ,pal-blue))))
   `(web-mode-html-tag-custom-face ((t (:foreground ,pal-blue))))
   `(web-mode-html-tag-unclosed-face ((t (:foreground ,ui-error :underline t))))
   `(web-mode-html-tag-namespaced-face ((t (:foreground ,pal-blue))))
   `(web-mode-html-tag-bracket-face ((t (:foreground ,ui-fg-dim))))
   `(web-mode-html-attr-name-face ((t (:foreground ,pal-yellow))))
   `(web-mode-html-attr-custom-face ((t (:foreground ,pal-yellow :slant italic))))
   `(web-mode-html-attr-engine-face ((t (:foreground ,pal-yellow))))
   `(web-mode-html-attr-equal-face ((t (:foreground ,ui-fg-dim))))
   `(web-mode-html-attr-value-face ((t (:foreground ,pal-green))))
   `(web-mode-block-attr-name-face ((t (:foreground ,pal-yellow))))
   `(web-mode-block-attr-value-face ((t (:foreground ,pal-green))))
   `(web-mode-variable-name-face ((t (:foreground ,syntax-variable))))
   `(web-mode-css-selector-face ((t (:foreground ,pal-cyan))))
   `(web-mode-css-selector-class-face ((t (:foreground ,pal-green))))
   `(web-mode-css-selector-tag-face ((t (:foreground ,pal-cyan))))
   `(web-mode-css-pseudo-class-face ((t (:foreground ,pal-cyan))))
   `(web-mode-css-at-rule-face ((t (:foreground ,syntax-keyword))))
   `(web-mode-css-property-name-face ((t (:foreground ,pal-blue))))
   `(web-mode-css-color-face ((t (:foreground ,syntax-constant))))
   `(web-mode-css-priority-face ((t (:foreground ,syntax-constant :weight bold))))
   `(web-mode-css-function-face ((t (:foreground ,pal-cyan))))
   `(web-mode-css-variable-face ((t (:foreground ,syntax-variable))))
   `(web-mode-function-name-face ((t (:foreground ,syntax-function))))
   `(web-mode-filter-face ((t (:foreground ,pal-cyan))))
   ...
   `(web-mode-json-key-face ((t (:foreground ,pal-blue))))
   ...
   `(web-mode-annotation-type-face ((t (:foreground ,pal-yellow))))
   `(web-mode-annotation-value-face ((t (:foreground ,pal-green))))
   ...
   `(web-mode-param-name-face ((t (:foreground ,ui-error))))
   ...
   `(wgrep-done-face ((t (:foreground ,ui-info))))
   ...
   ;; === Which-key (missing) ===
   `(which-key-local-map-description-face ((t (:foreground ,ui-link))))
   ...
   `(widget-button-pressed ((t (:foreground ,ui-error))))
   ...
   `(centaur-tabs-unselected-modified ((t (:background ,ui-bg-dark :foreground ,ui-accent))))
   ...
   `(spaceline-evil-insert ((t (:background ,ui-info))))
   ...
   `(spaceline-flycheck-warning ((t (:foreground ,ui-link))))
   ...
   `(sml/modified ((t (:foreground ,ui-link))))
   `(sml/outside-modified ((t (:foreground ,ui-link))))
   `(sml/process ((t (:weight bold))))
   `(sml/read-only ((t (:foreground ,ui-link))))
   `(sml/sudo ((t (:foreground ,ui-error :weight bold))))
   `(sml/vc-edited ((t (:foreground ,ui-info))))
