...
(let* (;; Tinted8 UI surface colors
  ...
  (custom-theme-set-faces
   ...
   `(term-color-red ((t (:foreground "#f38ba8" :background "#f38ba8"))))
   `(term-color-green ((t (:foreground "#a6e3a1" :background "#a6e3a1"))))
   `(term-color-yellow ((t (:foreground "#f9e2af" :background "#f9e2af"))))
   `(term-color-blue ((t (:foreground "#89b4fa" :background "#89b4fa"))))
   `(term-color-magenta ((t (:foreground "#cba6f7" :background "#cba6f7"))))
   `(term-color-cyan ((t (:foreground "#94e2d5" :background "#94e2d5"))))
   `(term-color-white ((t (:foreground "#cdd6f4" :background "#cdd6f4"))))
