...
(let* (;; Tinted8 UI surface colors
       ...
       (ui-button-bg "#ece9df")
       (ui-button-fg "#1f1f1f")
       (ui-tooltip-bg "#efeddc")
       (ui-tooltip-fg "#1f1f1f")
       (ui-active-text-bg "#cfcfde")
       (ui-active-text-fg "#000000")
       (ui-search-bg "#a34d14")
       (ui-search-fg "#f5f5f5")
       ...
       (syntax-function "#14720a")
       (syntax-keyword "#a3134d")
       (syntax-string "#836e15")
       (syntax-type "#036a96")
       ;; Give variables/imported names a distinct hue instead of blending into
       ;; the default foreground.
       (syntax-variable "#1f1f1f")
       (syntax-warning "#d74c3d")
       (syntax-preprocessor "#462da9")
       (syntax-annotation "#836e15")
  ...
  (custom-theme-set-faces
   ...
   `(term-color-green ((t (:foreground "#14720a" :background "#14720a"))))
   `(term-color-yellow ((t (:foreground "#836e15" :background "#836e15"))))
   `(term-color-blue ((t (:foreground "#644ac9" :background "#644ac9"))))
   `(term-color-magenta ((t (:foreground "#a3134d" :background "#a3134d"))))
   `(term-color-cyan ((t (:foreground "#036a96" :background "#036a96"))))
   `(term-color-white ((t (:foreground "#f5f5f5" :background "#f5f5f5"))))
   ...
   `(ansi-color-bright-black ((t (:foreground "#2c2b31" :background "#2c2b31"))))
   `(ansi-color-bright-red ((t (:foreground "#d74c3d" :background "#d74c3d"))))
   `(ansi-color-bright-green ((t (:foreground "#198d0c" :background "#198d0c"))))
   `(ansi-color-bright-yellow ((t (:foreground "#9e841a" :background "#9e841a"))))
   `(ansi-color-bright-blue ((t (:foreground "#7862d0" :background "#7862d0"))))
   `(ansi-color-bright-magenta ((t (:foreground "#bf185a" :background "#bf185a"))))
   `(ansi-color-bright-cyan ((t (:foreground "#047fb4" :background "#047fb4"))))
   ...
   `(term-color-bright-black ((t (:foreground "#2c2b31" :background "#2c2b31"))))
   `(term-color-bright-red ((t (:foreground "#d74c3d" :background "#d74c3d"))))
   `(term-color-bright-green ((t (:foreground "#198d0c" :background "#198d0c"))))
   `(term-color-bright-yellow ((t (:foreground "#9e841a" :background "#9e841a"))))
   `(term-color-bright-blue ((t (:foreground "#7862d0" :background "#7862d0"))))
   `(term-color-bright-magenta ((t (:foreground "#bf185a" :background "#bf185a"))))
   `(term-color-bright-cyan ((t (:foreground "#047fb4" :background "#047fb4"))))
