...
(let* (;; Tinted8 UI surface colors
       ...
       (ui-selection-bg "#465165")
       (ui-selection-fg "#e5e9f0")
       (ui-button-bg "#465165")
       (ui-button-fg "#e5e9f0")
       (ui-tooltip-bg "#14171d")
       (ui-tooltip-fg "#e5e9f0")
       (ui-active-text-bg "#616e88")
       (ui-active-text-fg "#e5e9f0")
       (ui-search-bg "#465165")
       (ui-search-fg "#ebcb8b")
       ...
       (syntax-variable "#e5e9f0")
       (syntax-warning "#d18d93")
       (syntax-preprocessor "#5e81ac")
       (syntax-annotation "#ebcb8b")
       (syntax-attribute "#ccb3c8")
  ...
  (custom-theme-set-faces
   ...
   `(term-color-red ((t (:foreground "#bf616a" :background "#bf616a"))))
   `(term-color-green ((t (:foreground "#a3be8c" :background "#a3be8c"))))
   `(term-color-yellow ((t (:foreground "#ebcb8b" :background "#ebcb8b"))))
   `(term-color-blue ((t (:foreground "#81a1c1" :background "#81a1c1"))))
   `(term-color-magenta ((t (:foreground "#b48ead" :background "#b48ead"))))
   `(term-color-cyan ((t (:foreground "#88c0d0" :background "#88c0d0"))))
   `(term-color-white ((t (:foreground "#e5e9f0" :background "#e5e9f0"))))
   ...
   `(ansi-color-bright-red ((t (:foreground "#d18d93" :background "#d18d93"))))
   `(ansi-color-bright-green ((t (:foreground "#c2d4b3" :background "#c2d4b3"))))
   `(ansi-color-bright-yellow ((t (:foreground "#f1e2c2" :background "#f1e2c2"))))
   `(ansi-color-bright-blue ((t (:foreground "#aac0d5" :background "#aac0d5"))))
   `(ansi-color-bright-magenta ((t (:foreground "#ccb3c8" :background "#ccb3c8"))))
   `(ansi-color-bright-cyan ((t (:foreground "#b4d7e1" :background "#b4d7e1"))))
   ...
   `(term-color-bright-black ((t (:foreground "#4c566a" :background "#4c566a"))))
   `(term-color-bright-red ((t (:foreground "#d18d93" :background "#d18d93"))))
   `(term-color-bright-green ((t (:foreground "#c2d4b3" :background "#c2d4b3"))))
   `(term-color-bright-yellow ((t (:foreground "#f1e2c2" :background "#f1e2c2"))))
   `(term-color-bright-blue ((t (:foreground "#aac0d5" :background "#aac0d5"))))
   `(term-color-bright-magenta ((t (:foreground "#ccb3c8" :background "#ccb3c8"))))
   `(term-color-bright-cyan ((t (:foreground "#b4d7e1" :background "#b4d7e1"))))
   `(term-color-bright-white ((t (:foreground "#eceff4" :background "#eceff4"))))
