...
(let* (;; Tinted8 UI surface colors
       ...
       (ui-selection-bg "#51576d")
       (ui-selection-fg "#c6d0f5")
       (ui-button-bg "#51576d")
       (ui-button-fg "#c6d0f5")
       (ui-tooltip-bg "#414559")
       (ui-tooltip-fg "#c6d0f5")
       (ui-active-text-bg "#949cbb")
       (ui-active-text-fg "#c6d0f5")
       (ui-search-bg "#81c8be")
       (ui-search-fg "#303446")
       ...
       (syntax-variable "#b06add")
       (syntax-warning "#eeb8b9")
       (syntax-preprocessor "#5281eb")
       (syntax-annotation "#e5c890")
       (syntax-attribute "#c4d2f3")
  ...
  (custom-theme-set-faces
   ...
   `(term-color-red ((t (:foreground "#e78284" :background "#e78284"))))
   `(term-color-green ((t (:foreground "#a6d189" :background "#a6d189"))))
   `(term-color-yellow ((t (:foreground "#e5c890" :background "#e5c890"))))
   `(term-color-blue ((t (:foreground "#8caaee" :background "#8caaee"))))
   `(term-color-magenta ((t (:foreground "#ca9ee6" :background "#ca9ee6"))))
   `(term-color-cyan ((t (:foreground "#81c8be" :background "#81c8be"))))
   `(term-color-white ((t (:foreground "#c6d0f5" :background "#c6d0f5"))))
   ...
   `(ansi-color-bright-black ((t (:foreground "#51576d" :background "#51576d"))))
   `(ansi-color-bright-red ((t (:foreground "#eeb8b9" :background "#eeb8b9"))))
   `(ansi-color-bright-green ((t (:foreground "#c7e2b5" :background "#c7e2b5"))))
   `(ansi-color-bright-yellow ((t (:foreground "#eee0c4" :background "#eee0c4"))))
   `(ansi-color-bright-blue ((t (:foreground "#c4d2f3" :background "#c4d2f3"))))
   `(ansi-color-bright-magenta ((t (:foreground "#e4d0f1" :background "#e4d0f1"))))
   `(ansi-color-bright-cyan ((t (:foreground "#acdbd4" :background "#acdbd4"))))
   `(ansi-color-bright-white ((t (:foreground "#b5bfe2" :background "#b5bfe2"))))
   ...
   `(term-color-bright-black ((t (:foreground "#51576d" :background "#51576d"))))
   `(term-color-bright-red ((t (:foreground "#eeb8b9" :background "#eeb8b9"))))
   `(term-color-bright-green ((t (:foreground "#c7e2b5" :background "#c7e2b5"))))
   `(term-color-bright-yellow ((t (:foreground "#eee0c4" :background "#eee0c4"))))
   `(term-color-bright-blue ((t (:foreground "#c4d2f3" :background "#c4d2f3"))))
   `(term-color-bright-magenta ((t (:foreground "#e4d0f1" :background "#e4d0f1"))))
   `(term-color-bright-cyan ((t (:foreground "#acdbd4" :background "#acdbd4"))))
   `(term-color-bright-white ((t (:foreground "#b5bfe2" :background "#b5bfe2"))))
