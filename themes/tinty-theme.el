...
(let* (;; Tinted8 UI surface colors
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1 ((t (:inherit ,vpitch :foreground ,pal-red :weight bold :height ,h1))))
   ...
   `(org-document-title ((t (:inherit ,vpitch :foreground ,pal-red :weight bold :height ,h-doc))))
   ...
   `(markdown-header-face-1 ((t (:inherit ,vpitch :foreground ,pal-red :weight bold :height ,h1))))
   ...
   `(info-title-1 ((t (:inherit ,vpitch :foreground ,pal-red :weight bold :height ,h1))))
   ...
   `(outline-1 ((t (:inherit ,vpitch :foreground ,pal-red :weight ultra-bold :height ,h1))))
   ...
   `(outline-minor-1 ((t (:inherit ,vpitch :foreground ,pal-red :weight ultra-bold :height ,h1))))
   ...
   `(anzu-mode-line ((t (:foreground ,pal-cyan :weight bold))))
   ...
   `(asciidoc-admonition-caution-label-face ((t (:foreground ,pal-yellow :weight bold))))
   ...
   `(asciidoc-admonition-note-label-face ((t (:foreground ,pal-blue :weight bold))))
   ...
   `(asciidoc-admonition-warning-label-face ((t (:foreground ,ui-error :weight bold))))
   `(asciidoc-anchor-face ((t (:foreground ,pal-magenta))))
   `(asciidoc-code-face ((t (:foreground ,pal-cyan :background ,ui-bg-dark :extend t))))
   `(asciidoc-cross-reference-face ((t (:foreground ,pal-magenta :underline t))))
   `(asciidoc-document-title-face ((t (:inherit ,vpitch :foreground ,ui-fg :weight bold :height ,h-doc))))
   `(asciidoc-footnote-marker-face ((t (:foreground ,pal-cyan))))
   `(asciidoc-footnote-text-face ((t (:foreground ,ui-fg-dim))))
   `(asciidoc-highlight-face ((t (:foreground ,ui-bg :background ,pal-yellow))))
   `(asciidoc-link-face ((t (:foreground ,pal-blue :underline t))))
   `(asciidoc-link-mouse-face ((t (:foreground ,pal-blue :background ,ui-bg-light :underline t))))
   ...
   `(asciidoc-title-1-face ((t (:inherit ,vpitch :foreground ,pal-red :weight bold :height ,h1))))
   ...
   `(asciidoc-url-face ((t (:foreground ,pal-blue :underline t))))
   ...
   `(breadcrumb-imenu-leaf-face ((t (:foreground ,pal-blue :weight bold))))
   ...
   `(dictionary-button-face ((t (:foreground ,pal-blue :underline t :weight bold))))
   `(dictionary-reference-face ((t (:foreground ,ui-link :underline t))))
   `(dictionary-word-definition-face ((t (:foreground ,ui-fg))))
   `(dictionary-word-entry-face ((t (:foreground ,pal-blue :weight bold))))
   ...
   `(erlang-edoc-macro ((t (:foreground ,pal-magenta))))
   `(erlang-edoc-tag ((t (:foreground ,ui-fg-dim))))
   `(erlang-edoc-todo ((t (:foreground ,ui-error :weight bold))))
   `(erlang-edoc-verbatim ((t (:foreground ,pal-cyan))))
   `(erlang-font-lock-exported-function-name-face ((t (:foreground ,pal-blue :weight bold))))
   `(font-latex-bold-face ((t (:foreground ,ui-fg :weight bold))))
   `(font-latex-italic-face ((t (:foreground ,ui-fg :slant italic))))
   `(font-latex-math-face ((t (:foreground ,pal-cyan))))
   `(font-latex-script-char-face ((t (:foreground ,pal-orange))))
   `(font-latex-sectioning-0-face ((t (:inherit ,vpitch :foreground ,pal-red :height ,h1 :weight bold))))
   ...
   `(font-latex-slide-title-face ((t (:inherit ,vpitch :foreground ,pal-blue :weight bold :height ,h1))))
   ...
   `(font-latex-verbatim-face ((t (:foreground ,pal-cyan :inherit fixed-pitch))))
   `(font-latex-warning-face ((t (:foreground ,pal-orange :weight bold))))
   ...
   `(git-timemachine-commit ((t (:foreground ,pal-orange :weight bold))))
   `(git-timemachine-minibuffer-author-face ((t (:foreground ,pal-blue))))
   `(git-timemachine-minibuffer-detail-face ((t (:foreground ,pal-cyan))))
   ...
   `(gptel-response-fringe-highlight ((t (:foreground ,pal-blue))))
   `(gptel-response-highlight ((t (:background ,ui-bg-dark :extend t))))
   `(gptel-rewrite-highlight-face ((t (:background ,ui-button-bg :extend t))))
   `(haskell-constructor-face ((t (:foreground ,pal-yellow))))
   `(haskell-definition-face ((t (:foreground ,pal-blue))))
   `(haskell-error-face ((t (:underline (:style wave :color ,ui-error)))))
   `(haskell-hole-face ((t (:foreground ,pal-yellow :weight bold))))
   `(haskell-interactive-face-compile-error ((t (:foreground ,ui-error :weight bold))))
   `(haskell-interactive-face-compile-warning ((t (:foreground ,pal-yellow :weight bold))))
   `(haskell-interactive-face-garbage ((t (:foreground ,ui-fg-dim))))
   `(haskell-interactive-face-prompt ((t (:foreground ,pal-blue :weight bold))))
   ...
   `(haskell-operator-face ((t (:foreground ,pal-cyan))))
   `(haskell-pragma-face ((t (:foreground ,pal-magenta))))
   `(haskell-quasi-quote-face ((t (:foreground ,ui-success))))
   `(haskell-type-face ((t (:foreground ,pal-yellow))))
   `(haskell-warning-face ((t (:underline (:style wave :color ,pal-yellow)))))
   ...
   `(jinx-save ((t (:foreground ,pal-orange :weight bold))))
   ...
   `(shr-h1 ((t (:inherit ,vpitch :foreground ,pal-red :weight bold :height ,h1))))
   ...
   `(shr-link ((t (:foreground ,pal-blue :underline t))))
   `(shr-selected-link ((t (:foreground ,pal-orange :underline t))))
   `(shr-code ((t (:foreground ,pal-cyan :background ,ui-bg-dark))))
   `(shr-mark ((t (:foreground ,ui-bg :background ,pal-yellow))))
   `(vundo-branch-stem ((t (:foreground ,ui-border))))
   `(vundo-diff-highlight ((t (:foreground ,pal-orange :weight bold))))
   `(vundo-highlight ((t (:foreground ,pal-blue :weight bold))))
   ...
   `(markdown-header-face-5 ((t (:inherit ,vpitch :foreground ,ui-accent :weight bold))))
   `(markdown-header-face-6 ((t (:inherit ,vpitch :foreground ,ui-link :weight bold))))
