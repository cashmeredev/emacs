...
(let* (;; Tinted8 UI surface colors
       ...
       (ui-selection-bg "#454158")
       (ui-selection-fg "#f8f8f2")
       (ui-button-bg "#2b293d")
       (ui-button-fg "#f8f8f2")
       (ui-tooltip-bg "#201f2e")
       (ui-tooltip-fg "#f8f8f2")
       (ui-active-text-bg "#454158")
       (ui-active-text-fg "#ededde")
       (ui-search-bg "#201f2e")
       (ui-search-fg "#ededde")
  ...
  (custom-theme-set-faces
   ...
   `(term-color-red ((t (:foreground "#ff9580" :background "#ff9580"))))
   `(term-color-green ((t (:foreground "#8aff80" :background "#8aff80"))))
   `(term-color-yellow ((t (:foreground "#ffff80" :background "#ffff80"))))
   `(term-color-blue ((t (:foreground "#9580ff" :background "#9580ff"))))
   `(term-color-magenta ((t (:foreground "#ff80bf" :background "#ff80bf"))))
   `(term-color-cyan ((t (:foreground "#80ffea" :background "#80ffea"))))
   ...
   `(ansi-color-bright-blue ((t (:foreground "#9580ff" :background "#9580ff"))))
   `(ansi-color-bright-magenta ((t (:foreground "#ff80bf" :background "#ff80bf"))))
   `(ansi-color-bright-cyan ((t (:foreground "#80ffea" :background "#80ffea"))))
   `(ansi-color-bright-white ((t (:foreground "#ededde" :background "#ededde"))))
   ...
   `(term-color-bright-blue ((t (:foreground "#9580ff" :background "#9580ff"))))
   `(term-color-bright-magenta ((t (:foreground "#ff80bf" :background "#ff80bf"))))
   `(term-color-bright-cyan ((t (:foreground "#80ffea" :background "#80ffea"))))
   `(term-color-bright-white ((t (:foreground "#ededde" :background "#ededde"))))
