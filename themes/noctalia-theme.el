...
(let* (;; Core surface colors
       ...
       (surface-container "#c6c6c6")
       (surface-container-low "#dddddd")
       (surface-container-lowest "#eaeaea")
       (surface-container-high "#bcbcbc")
       (surface-container-highest "#b2b2b2")
       ...
       (primary-container "#bad0f7")
       (secondary-container "#7cd095")
       (tertiary-container "#d3bbf6")
       (err-container "#edbec0")
       ...
       (on-primary-container "#001b4c")
       (on-secondary-container "#0c401c")
       (on-tertiary-container "#1f014b")
       (on-err-container "#43090c")
       ...
       (primary-variant "#0143c0")
       (secondary-variant "#25c054")
       (tertiary-variant "#5f04eb")
       (err-variant "#e95c63"))
